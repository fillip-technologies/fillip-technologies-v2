...
CATEGORIES = [
    {
        ...
        "packages": [
            {"name": "Basic Package", "tagline": "The Starter", "price": 10000, "billing": "one-time",
             "timeline": "3 days", "bestFor": "Individuals, Startups, and Small Businesses.",
             "groups": [
                 ("Design & Development", ["5–7 Custom Designed Pages",
                                            "100% Mobile Responsive (Mobile, Tablet, Desktop)",
                                            "Modern UI/UX focused on user engagement",
                                            "Professional Image Slider/Banner"]),
                 ("Features", ["Functional Contact Form with Email Notifications",
                                "Social Media Icon Integration",
                                "WhatsApp Chat Integration for instant queries"]),
                 ("Optimization", ["Basic On-Page SEO (Meta tags and titles)",
                                    "Fast Loading Speed optimization"]),
             ]},
            {"name": "Standard Package", "tagline": "The Professional", "price": 25000, "billing": "one-time",
             "timeline": "7 days", "bestFor": "Established businesses looking for a dynamic presence.",
             "groups": [
                 ("Core Deliverables", ["10–15 Premium Pages",
                                         "Dynamic CMS: Admin Panel to update content without coding",
                                         "Advanced Custom UI/UX tailored to your brand identity"]),
                 ("Marketing & SEO", ["Full SEO Infrastructure Setup",
                                       "Google Maps Integration",
                                       "Blog Section Setup for content marketing"]),
                 ("Technical", ["Enhanced Security Protocols",
                                 "Google Analytics and Search Console integration",
                                 "Lead Generation pop-ups"]),
             ]},
            {"name": "Premium Package", "tagline": "The Enterprise", "price": 75000, "billing": "one-time",
             "timeline": "15 days", "bestFor": "E-commerce stores and high-scale corporate portals.",
             "groups": [
                 ("Advanced Functionality", ["Full E-commerce Setup (Unlimited Product Listing)",
                                              "Secure Payment Gateway (Razorpay/Paytm/Stripe)",
                                              "Inventory and Order Management System"]),
                 ("Automation", ["CRM Integration for lead tracking",
                                  "Automated Invoice Generation",
                                  "Advanced Product Filtering and Search"]),
                 ("Support", ["Premium Technical Support (6 Months)",
                               "Advanced Speed Optimization"]),
             ]},
        ],
        "addOns": [
            {"name": "Extra Page", "price": 1000, "billing": "one-time", "unit": "page"},
            {"name": "Logo Design", "price": 3000, "billing": "one-time"},
            {"name": "Multilingual Support", "price": 8000, "billing": "one-time"},
            {"name": "Payment Gateway Integration", "price": 6000, "billing": "one-time"},
            {"name": "Annual Maintenance (AMC)", "price": 2000, "billing": "monthly"},
            {"name": "Hosting & Domain Setup", "price": 4000, "billing": "one-time"},
        ],
    },
    {
        ...
        "packages": [
            {"name": "Basic SEO", "price": 8000, "billing": "monthly", "timeline": "Per month",
             "bestFor": "10–15 Target Keywords.",
             "groups": [
                 ("Activities", ["Initial Website Audit & Error Removal",
            ...
            {"name": "Advanced SEO", "price": 18000, "billing": "monthly", "timeline": "Per month",
             "bestFor": "20–30 Target Keywords.",
             "groups": [
                 ("Activities", ["Deep Technical SEO (Schema, Sitemap, Robots.txt)",
