...
const testimonials = [
    ...
    },
    {
        ...
        review:
            "Fillip Technologies helped us create a complete patient acquisition system. Visibility, trust, and appointment bookings all improved together.",
    },
];
            ...
            <div className="container mx-auto max-w-7xl px-6">
                ...
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mt-5 text-lg leading-8 text-slate-600">
                        Hospitals, clinics, and healthcare specialists trust Fillip
                        Technologies to improve visibility, strengthen patient trust,
                        and generate more appointment opportunities.
                    </p>
                </div>
                ...
                <div className="mt-20 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {[-1, 0, 1].map((offset, index) => {
                        ...
                        return (
                            <div
                                key={item.name}
                                className={`relative transition-all duration-500 ${center
