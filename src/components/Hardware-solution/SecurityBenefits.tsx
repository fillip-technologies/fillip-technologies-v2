...
const benefits = [
  {
    ...
    description: "Round-the-clock monitoring by security experts.",
  },
  {
    icon: Wrench,
    title: "Easy Installation",
    description: "Quick and hassle-free setup for complete protection.",
  },
  {
    icon: MonitorSmartphone,
    title: "Mobile Access",
    description: "Control and monitor your system from anywhere.",
  },
  {
    icon: ShieldCheck,
    title: "Trusted by Thousands",
    description: "Thousands of homes and businesses trust Fillip Technologies.",
  },
];
  ...
  return (
    <section className="relative overflow-hidden bg-white py-20 text-slate-950 sm:py-24 lg:py-28">
      ...
      >
        ...
        <motion.h2
          variants={itemVariants}
          className="mt-6 max-w-2xl text-4xl font-black leading-[1.08] tracking-tight text-slate-950 sm:text-5xl"
        >
