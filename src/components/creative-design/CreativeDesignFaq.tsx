...
// Creative-design FAQ section. Uses native <details>/<summary> so it stays a
// server component while remaining interactive (no client JS needed).
export default function CreativeDesignFaq({
  data,
}: {
  data: CreativeDesignContent["faq"];
}) {
  if (!data) return null;
