...
// SE-specific FAQ section. Uses native <details>/<summary> so it stays a server
// component while remaining interactive (no client JS needed).
export default function SoftwareEnterpriseFaq({
  data,
}: {
  data: SoftwareEnterpriseContent["faq"];
}) {
  if (!data) return null;
