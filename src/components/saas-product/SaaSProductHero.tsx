...
import { ArrowRight, Play, CheckCircle2, ShieldCheck, Database, Layers } from "lucide-react";

export default function SaaSProductHero() {
  // Framer Motion variants for layered card stack
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 text-left flex flex-col items-start">
            ...
            >
              Turn Your Vision into a Scalable <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-indigo-650 to-blue-700 font-bold">SaaS Engine</span>
            </motion.h1>
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-xs font-semibold text-slate-700">Logical Tenant Isolation</span>
              </div>
              <div className="flex items-center gap-2.5">
                <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-blue-50 text-blue-650">
                  <ShieldCheck className="h-4 w-4" />
                </div>
                <span className="text-xs font-semibold text-slate-700">WAF Guard & SSO Auth</span>
              </div>
              <div className="flex items-center gap-2.5">
                <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-blue-50 text-blue-650">
                  <Layers className="h-4 w-4" />
                </div>
                <span className="text-xs font-semibold text-slate-700">Multi-Tier Subscriptions</span>
              </div>
              <div className="flex items-center gap-2.5">
                <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-blue-50 text-blue-650">
                  <CheckCircle2 className="h-4 w-4" />
                </div>
                <span className="text-xs font-semibold text-slate-700">CI/CD Production Pipelines</span>
              </div>
            </motion.div>
          ...
          <div className="lg:col-span-6 flex items-center justify-center relative min-h-[500px] select-none">
            ...
            {/* Visual Container triggering hover */}
            <motion.div
            ...
            >
              {/* Back Card (Layer A - Enterprise Dashboard Console) */}
              <motion.div
              ...
              >
                ...
                <div className="relative h-full w-full rounded-b-xl overflow-hidden mt-1 bg-slate-100">
                  <Image
                    ...
                    alt="SaaS Back-End Engine Cluster Mockup"
                    fill
              ...
              {/* Middle Card (Layer B - Main Desk Setup monitor screen) */}
              <motion.div
              ...
              >
                <div className="flex items-center gap-1.5 px-3 py-1.5 border-b border-slate-100 bg-slate-50/50 rounded-t-xl">
                  ...
                  <span className="text-[8px] font-mono text-slate-400 ml-2">saas-dashboard.fillip.app</span>
                </div>
                <div className="relative h-full w-full rounded-b-xl overflow-hidden mt-1 bg-slate-50">
                  <Image
                    src="/images/saas-desk-setup.png"
                    alt="SaaS Platform Front-End Console Mockup"
                    fill
              ...
              {/* Front Card (Layer C - Stripe Checkout Glassmorphic receipt widget) */}
              <motion.div
              ...
              >
                <div>
                  <div className="flex justify-between items-center border-b border-white/10 pb-3 mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold text-slate-200">Stripe Billing active</span>
                    </div>
                ...
                <div className="flex justify-between items-center bg-white/5 border border-white/10 p-2.5 rounded-xl text-[9px] font-semibold text-slate-300">
                  <span className="flex items-center gap-1.5">
                    ...
                    <span>AWS Node-4 routing active</span>
                  </span>
