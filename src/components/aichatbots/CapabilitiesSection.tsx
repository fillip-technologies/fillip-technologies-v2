...
export default function CapabilitiesSection({
    ...
    data: AIAutomationContent["capabilities"];
}) {
    return (
            ...
            <div className="mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-12">
                ...
                >
                    ...
                    <h2 className="mt-4 font-display text-5xl leading-none tracking-tight lg:text-6xl">
                        {data.title}
                        <br />
                        <em className="not-italic text-primary-glow">
                ...
                >
                    {data.items.map((label, i) => {
                        ...
                        return (
                            <div
                                key={label}
                                className="flex items-center gap-4 border-b border-white/10 py-5 sm:odd:border-r sm:odd:pr-6 sm:even:pl-6"
                            >
                                ...
                                <ArrowUpRight className="ml-auto size-4 text-white/20" />
                            </div>
                        );
                    })}
                </motion.div>
