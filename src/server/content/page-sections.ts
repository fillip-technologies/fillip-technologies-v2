...
export const ABOUT_PAGES: PageGroup[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: "The three columns (Mission, Vision, Creed), the Leadership & Team block (CEO + team members) and the closing signature.",
        ready: true,
        fields: [
          ...
          { name: "leadershipEyebrow", label: "Leadership — eyebrow", type: "text", default: "Leadership & Team" },
          { name: "leadershipHeading", label: "Leadership — heading", type: "text", default: "The People Behind The Pages" },
          { name: "leadershipDescription", label: "Leadership — description", type: "textarea", default: "One clear leadership voice, supported by a focused team of builders, designers, and growth specialists." },
          { name: "ceoName", label: "CEO — name", type: "text", default: "Vikash Kumar" },
          { name: "ceoRole", label: "CEO — role", type: "text", default: "Founder & CEO" },
          { name: "ceoExperience", label: "CEO — experience", type: "text", default: "13+ Years of Experience" },
          { name: "ceoImage", label: "CEO — photo", type: "image", default: "/images/team/VIKASH.jpeg" },
          { name: "ceoMessage", label: "CEO — message", type: "textarea", default: "Fillip Technologies was built with a simple belief: technology should make businesses clearer, faster, and more capable. Every solution we deliver carries our promise of discipline, transparency, and meaningful digital impact for the businesses we serve." },
