...
export const metadata: Metadata = {
  ...
  description:
    "Tell us your exact requirements — industry, budget and scope — and we'll craft a tailored quote for your project.",
};
  ...
  return (
    <section className="mx-auto max-w-3xl px-6 py-14 sm:px-8 sm:py-16 lg:px-12">
      <header className="mb-8 max-w-2xl">
        <h1 className="text-4xl font-bold leading-[1.05] tracking-[-0.04em] text-[var(--heading)] md:text-5xl">
