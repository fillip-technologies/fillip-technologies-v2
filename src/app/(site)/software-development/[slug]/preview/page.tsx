...
/**
 * Draft preview of a software-enterprise page — session-gated, works while
 * unpublished.
 */
export default async function SoftwareEnterprisePreviewPage({
  params,
}: {
  ...
  if (!page || page.template !== "software-enterprise") notFound();
