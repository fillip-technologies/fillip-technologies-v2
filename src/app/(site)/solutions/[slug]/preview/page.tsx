...
/**
 * Draft preview of a business-solution page — session-gated, works while
 * unpublished.
 */
export default async function BusinessSolutionPreviewPage({
  params,
}: {
  ...
  if (!page || page.template !== "business-solution") notFound();
