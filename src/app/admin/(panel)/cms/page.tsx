    ...
    areas: [
      {
        ...
        label: "Solutions",
        description: "Business & Hardware Solution pages behind the Solutions menu, including the custom-layout pages. Create, edit, publish.",
        icon: Boxes,
        accent: "orange",
      },
    ],
  },
  {
    ...
    areas: [
      ...
      },
      {
        ...
        label: "Locations",
        description: "Create and manage “<service> in <city>” landing pages, city by city.",
        icon: MapPin,
        accent: "sky",
      },
      {
